...
same ticket -> same embarked and fare
...
train_df0 = train_df
train_df0 = train_df0.drop(['PassengerId','Name','Ticket','Cabin'],axis=1)
train_df0['Embarked'] = train_df0['Embarked'].fillna('C') - from test3.py
...
final_df.to_csv('F:/TA/Analytics/Kaggle/Titanic/Code/Submission1.csv')
